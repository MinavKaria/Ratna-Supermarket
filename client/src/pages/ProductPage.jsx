    ...
    async function getimgURL() {
      try {
        const response = await axios.get(
          `https://ratna-supermarket.vercel.app/product/${id}`
        );
        ...
        <div className="container flex justify-around md:px-1 px-10">
          <div className="lg:flex-row mt-[10vh] flex flex-col gap-[7.5vw]  md:mx-32 items-center">
            ...
            <div className="flex flex-col gap-4">
              <span className="font-black md:text-[2vw] text-3xl">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-[2.5vh]">
                  ...
                  <span className="text-[2vh] font-[100] line-through">
                    ₹{products.mrp}
                  </span>
                </span>
              </div>
              ...
              {count > 0 && (
                <div className="mr-2 flex gap-2">
                  ...
                  <div>
                    <input
                      type="text"
                      className="w-6 border-2 indent-1"
                      value={count}
                    />
                  </div>
                  <span
              ...
              <span>
                ...
                Voluptas eveniet doloremque magni voluptatum, hic sed excepturi
                animi aut in debitis.
              </span>
