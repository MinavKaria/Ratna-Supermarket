...
function Signup() {
  console.log(areAllCharactersNumbers("1234567890"));
  ...
  const [validPhone, setValidPhone] = useState(false); // eslint-disable-line no-unused-vars
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      setUserDetails(user);
      const uid = user.uid; // eslint-disable-line no-unused-vars
  ...
  const {
    isLogin, // eslint-disable-line no-unused-vars
    setIsLogin,
    name, // eslint-disable-line no-unused-vars
    setName,
    userDetails, // eslint-disable-line no-unused-vars
    setUserDetails,
  } = useCart(); // eslint-disable-line no-unused-vars
          ...
          >
            ...
            <Grid item xs={6}>
              ...
              >
                ...
                <button
                  className="w-72 p-2 rounded-2xl text-white mt-2"
