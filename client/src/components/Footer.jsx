  ...
  return (
    <>
      ...
      <div class="flex flex-row gap-[5vw] container justify-start items-center mx-auto ">
        <div class="flex flex-col gap-2 items-start justify-items-start w-full">
            <p class="text-1xl">Download GMart ready for Mobile App Now!!</p>
    
            <div class="flex gap-4">
                <img class="h-16 flex -m-2" src="./gpp.png" alt="Google Play Logo"/>
        ...
        <div className=" flex w-full justify-end gap-3">
          <div class="flex flex-col gap-[0vh] w-48">
              <p>FAQs</p>
              <p>Privacy Policy</p>
    ...
    <hr class="w-full border-[0.03vh] border-[#000000] mx-auto my-[2vh]"/>
